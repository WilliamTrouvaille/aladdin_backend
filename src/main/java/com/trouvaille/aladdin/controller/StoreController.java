...
public class StoreController {
    ...
    public R<Page<Store>> page (int page , int pageSize , String name) {
        ...
        this.storeService.page(pageInfo , lqw);
    ...
    public R<List<Store>> list () {
        log.info("获取全部门店信息");
        List<Store> stores = this.storeService.list(null);
    ...
    public R<String> save (@RequestBody Store store) {
        ...
        boolean save = this.storeService.save(store);
    ...
    public R<String> update (@RequestBody Store store) {
        ...
        boolean flag = this.storeService.updateById(store);
